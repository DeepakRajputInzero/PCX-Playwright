...
test.describe("Create New Test Standard record and update Calibration Result_Switch Test", () => {
  ...
  test("Create Asset Record and update Calibration Result- Switch Test", async ({ page }) => {
    ...
    let locString = "TS-SWITCH-ID-00" + randomNumber;
    ...
    await page.locator('input[name="SerialNumber"]').fill("SN"+locString);
    ...
    let locString1 = "TS-STCalibration-00" + randomNumber;
    ...
    await page
      ...
      await page
      .locator(
        '//*[@id="dialog-test-specifications-container"]/div[2]/div[2]/div[1]/div[2]/input[@type="text"]'
      )
      .click();
    await page
      .locator(
    ...
    await page
      .locator(
        '//*[@id="dialog-test-specifications-container"]/div[2]/div[2]/div[5]/div[2]/table/tbody[1]/tr[1]/td[2]/div/input[1]'
      )
      .fill("2");
    await page
      .locator(
        '//*[@id="dialog-test-specifications-container"]/div[2]/div[2]/div[5]/div[2]/table/tbody[1]/tr[1]/td[3]/select'
      )
      .selectOption("1");
    await page
      .locator(
        '//*[@id="dialog-test-specifications-container"]/div[2]/div[2]/div[5]/div[2]/table/tbody[1]/tr[1]/td[4]/select'
      )
      .selectOption("2");
    //Save record
    ...
    await page.locator('//*[@id="tab-result-details"]/div[5]/div[5]/div/div/input').click();
    
    await page.locator('//*[@id="tab-result-details"]/div[5]/div[5]/div/div[2]/div/div[49]').click();
    ...
    await page
      .locator(
        '//*[@id="dialog-test-specification-type-container"]/div[2]/div/table/tbody/tr/td[8]/input'
      )
      .fill("2"); 
