...
test.describe("Create New Test Standard record and update Calibration Result_Test Point Accurecy", () => {
  ...
  test("Create Asset Record and update Calibration Result- Test Point Accurecy", async ({ page }) => {
    ...
    let locString = "TS-TPA-ID-00" + randomNumber;
    ...
    let locString1 = "TS-TPACali-00" + randomNumber;
    ...
    await page
      .locator(
        '//*[@id="dialog-test-specification-type-container"]/div[3]/div[2]/table/tbody/tr[1]/td[3]/input'
      )
      .fill("10"); 
    await page
      .locator(
        '//*[@id="dialog-test-specification-type-container"]/div[3]/div[2]/table/tbody/tr[1]/td[7]/input'
      )
      .fill("10");
    await page
      .locator(
        '//*[@id="dialog-test-specification-type-container"]/div[3]/div[2]/table/tbody/tr[2]/td[3]/input'
      )
      .fill("50");
    await page
      .locator(
        '//*[@id="dialog-test-specification-type-container"]/div[3]/div[2]/table/tbody/tr[2]/td[7]/input'
      )
      .fill("50");
