...
test.describe("Create New record and update Calibration Result-Switch Test", () => {
  ...
  test("Create Asset Record and update Calibration Result-Swtich Test", async ({ page }) => {
    ...
    let locString = "Instrument-Id-0" + randomNumber;
    ...
    await page
      ...
      .click();
    //Genrate Asset Id
    let random = "Switch-Calibration-0" + randomNumber;
