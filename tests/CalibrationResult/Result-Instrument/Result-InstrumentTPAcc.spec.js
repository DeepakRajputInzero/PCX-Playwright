...
test.describe("Create New Instrument record and update Calibration Result-Test Point Accurecy", () => {
  ...
  test("Create Asset Record and update Calibration Result-Test Point Accurecy", async ({ page }) => {
    ...
    await page
      ...
      .click();
    //Genrate Asset Id
    let random = "TPA-Calibration-0" + randomNumber;
    ...
    await page
      .locator(
        '//*[@id="dialog-test-specification-type-container"]/div[3]/div[2]/table/tbody/tr[1]/td[3]/input[1]'
      )
      .fill("10");    
    await page.locator('//*[@id="dialog-test-specification-type-container"]/div[3]/div[2]/table/tbody/tr[1]/td[7]/input').fill('10');
